...
public class ProductosServices {
    ...
    public Productos updateProducto(Long id, String nombre, String descripcion, Double precio, Long stock, Long cantidad, Long puntos, String imagen) {
    	Productos tmpProd = null;
		if(productosRepository.existsById(id)) {
			tmpProd = productosRepository.findById(id).get();
				...
				if (puntos!=null)tmpProd.setStock(puntos);
